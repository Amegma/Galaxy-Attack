...
def controls():
    ...
    while run:
        ...
        control_title_label = control_title_font.render(
            'Controls', 1, (0, 0, 209))
        Config.CANVAS.blit(control_title_label, (window_width//2 -
                                                 control_title_label.get_width()//2 - 30, 130))
        Config.CANVAS.blit(CONTROL_IMAGE, (window_width//2 +
                                           control_title_label.get_width()//2 - 10, 112))

        shoot_label = control_font.render('Shoot', 1, (0, 225, 0))
        Config.CANVAS.blit(shoot_label, (starting_x + 125, 215))
        shoot_key_label = keys_font.render('[spacebar]', 1, (240, 0, 0))
        Config.CANVAS.blit(shoot_key_label, (starting_x + 470, 215))

        left_label = control_font.render('Move Left', 1, (0, 225, 0))
        Config.CANVAS.blit(left_label, (starting_x + 125, 270))
        left_key_label = keys_font.render('[left] or [a]', 1, (240, 0, 0))
        Config.CANVAS.blit(left_key_label, (starting_x + 470, 270))

        right_label = control_font.render('Move Right', 1, (0, 225, 0))
        Config.CANVAS.blit(right_label, (starting_x + 125, 325))
        right_key_label = keys_font.render('[right] or [d]', 1, (240, 0, 0))
        Config.CANVAS.blit(right_key_label, (starting_x + 470, 325))

        down_label = control_font.render('Move Down', 1, (0, 225, 0))
        Config.CANVAS.blit(down_label, (starting_x + 125, 380))
        down_key_label = keys_font.render('[down] or [s]', 1, (240, 0, 0))
        Config.CANVAS.blit(down_key_label, (starting_x + 470, 380))

        up_label = control_font.render('Move Up', 1, (0, 225, 0))
        Config.CANVAS.blit(up_label, (starting_x + 125, 435))
        up_key_label = keys_font.render('[up] or [w]', 1, (240, 0, 0))
        Config.CANVAS.blit(up_key_label, (starting_x + 470, 435))

        escape_label = control_font.render(
            'Return back to home', 1, (0, 225, 0))
        Config.CANVAS.blit(escape_label, (starting_x + 125, 490))
        escape_key_label = keys_font.render('[backspace]', 1, (240, 0, 0))
        Config.CANVAS.blit(escape_key_label, (starting_x + 470, 490))

        mute_label = control_font.render('Mute Audio', 1, (0, 225, 0))
        Config.CANVAS.blit(mute_label, (starting_x + 125, 545))
        mute_key_label = keys_font.render('[m]', 1, (240, 0, 0))
        Config.CANVAS.blit(mute_key_label, (starting_x + 470, 545))

        sfx_label = control_font.render('Volume Up/Down', 1, (0, 225, 0))
        Config.CANVAS.blit(sfx_label, (starting_x + 125, 600))
        sfx_key_label = keys_font.render('[+]/[-]', 1, (240, 0, 0))
        Config.CANVAS.blit(sfx_key_label, (starting_x + 470, 600))

        sfx_label = control_font.render('Toggle Full Screen', 1, (0, 225, 0))
        Config.CANVAS.blit(sfx_label, (starting_x + 125, 655))
        sfx_key_label = keys_font.render('[f]', 1, (240, 0, 0))
        Config.CANVAS.blit(sfx_key_label, (starting_x + 470, 655))
